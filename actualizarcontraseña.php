...
$email=$_SESSION['login'];
  $sql ="SELECT Password FROM tblusuarios WHERE EmailId=:email and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblusuarios set Password=:newpassword where EmailId=:email";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':email', $email, PDO::PARAM_STR);
$chngpwd1-> bindParam(':newpassword', $newpassword, PDO::PARAM_STR);
$chngpwd1->execute();
$msg="Su contreseña Fue exitosamente cambiada";
}
else {
