...
<title>ArrendadoraPTY | Mis Testimonios </title>
<!--Bootstrap -->
...
<?php 
$useremail=$_SESSION['login'];
$sql = "SELECT * from tbltestimonios where UserEmail=:useremail";
$query = $dbh -> prepare($sql);
$query -> bindParam(':useremail',$useremail, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Activo</a>
                  ...
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Esperando por aprovación</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
