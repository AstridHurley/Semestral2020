...
$sql="update tblvehiculos set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
...
<head>
	...
	<title>Arrendadora PTY | Administracion de detalles del vehiculo</title>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT tblvehiculos.*,tblmarcas.BrandName,tblmarcas.id as bid from tblvehiculos join tblmarcas on tblmarcas.id=tblvehiculos.VehiclesBrand where tblvehiculos.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php $ret="select id,BrandName from tblmarcas";
...
<div class="form-group">
<label class="col-sm-2 control-label">Vista General del vehiculo
...
<label class="col-sm-2 control-label">Seleccion tipo de combustible<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Capacidad de Asiento<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="cambiodeimagen1.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen
 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="cambiodeimagen2.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen
 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="cambiodeimagen3.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen
 3</a>
</div>
</div>
...
<a href="cambiodeimagen4.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen
 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="cambiodeimagen5.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox2"> Cierre de puertas </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Sistema de antibloqueo de freno </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Asistencia de frenado </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Airbag del conductor</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Airbag del pasajero </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Reproductor de sonido </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Cierre Central</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
