...
$sql="update tblinformacioncontactos set Address=:address,EmailId=:email,ContactNo=:contactno";
...
<head>
	...
	<title>Car Rental Portal | Admin Crear Marca</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">CAMPO FORMULARIO</div>
				...
				<?php $sql = "SELECT * from  tblinformacioncontactos ";
$query = $dbh -> prepare($sql);
$query->execute();
