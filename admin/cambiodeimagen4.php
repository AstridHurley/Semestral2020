...
$sql="update tblvehiculos set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Arrendadora PTY | Administracion de cambio de imagen 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehiculo imagen 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Vehiculo imagen 4 Detalles</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from tblvehiculos where tblvehiculos.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Cargar nueva imagen 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
