...
if($lastInsertId)
{
$msg="Vehiculo posteado exitosamente";
}
else 
{
...
<div class="form-group">
<label class="col-sm-2 control-label">Vista del Vehiculo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label for="powerdoorlocks"> Cierre central </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="antilockbrakingsys" name="antilockbrakingsys" value="1">
<label for="antilockbrakingsys"> Systeme de antibloqueo de frenado </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
<label for="brakeassist"> Asistencia de frenado </label>
</div>
</div>
...
<label for="passengerairbag"> Airbag del pasajero </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
<label for="powerwindow"> Ventanas electricas </label>
</div>
</div>
...
<label for="centrallocking">Cierre Central</label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="crashcensor" name="crashcensor" value="1">
<label for="crashcensor"> Sensores de choque </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
